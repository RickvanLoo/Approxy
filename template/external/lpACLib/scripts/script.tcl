...
# variable
set BASE_DIR /home/harouni/WORK/2x2/configMult #TODO: change path to work directory

#set SIM_DIR ./

set DESIGN_NAME Config2x2MultLit #TODO: change to top entity name
...
#TODO: list all source files (2 files for accuracy configurable and 1 file for all the rest)
analyze -f VHDL {./Config2x2MultLit.vhd ./Approx2x2MultLit.vhd}
