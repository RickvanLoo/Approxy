...
// CreateXSIM creates an XSIM environment on bases of an array of VHDLEntities
...
// CreateFile recreates TB File, neccesary for PostPlacement sim after behavioural analysis
...
// ParseXSIMReport parses the exported XSIM _xsimlog. If pattern "!!ERROR!!PATTERN!!" is detected, as used in all TBs, an error is thrown
// If an error is thrown, the Approxy model does not accurately describe the exported VHDL file
